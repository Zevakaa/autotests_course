...
class Trigon:
    """ Проверка на треугольник. На вход - длины 3х сторон """
    def __init__(self, *args):
        ...
        if ((args[0] < args[1] + args[2]) and (args[0] > args[1] - args[2]) and (
                args[1] < args[0] + args[2]) and (args[1] > args[0] - args[2]) and (
                 args[2] < args[0] + args[1]) and (args[2] > args[0] - args[1])) is False:
